...
import { r as TEMPLATES } from "./templates-BbIr5AV_.mjs";
import { n as Navbar, t as Footer } from "./navbar-Cb_RGtxv.mjs";
import { t as InvitationRenderer } from "./renderer-Mtzyrdmu.mjs";
import { a as HowItWorks, c as Pricing, d as VideoDemo, f as Why, i as FinalCta, l as Showcase, n as FaqSection, o as InvitationTypes, r as Features, s as LiveInvitation, t as Catalog, u as Testimonials } from "./sections-CnXMrdex.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-CyD8QKEC.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var CurtainGuard = class extends import_react.Component {
	state = { failed: false };
...
function SilkCurtain({ className = "" }) {
	...
	const fallback = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StaticSilk, { className });
	if (!Scene || reduce) return fallback;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CurtainGuard, {
		fallback,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Scene, { className })
	});
}
function Hero() {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute -inset-6 rounded-[28px] bg-gold/25 blur-2xl" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "relative aspect-[9/16] w-full overflow-hidden rounded-[22px] shadow-[0_40px_80px_-20px_rgba(20,8,10,0.55)]",
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: offsets.map((offset) => {
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								type: "button",
								className: cn("block overflow-hidden rounded-[22px] text-left shadow-[0_28px_70px_-24px_rgba(44,31,26,0.48)]", isCenter ? "h-[500px] w-[280px]" : "h-[380px] w-[214px]"),
								onClick: () => {

...
import { t as AUTH_PROVIDERS } from "./server-C3cAiqV9.mjs";
import { s as Route$12 } from "./router-CVdbLN9V.mjs";
import { r as signIn } from "./client-NDugtlEs.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/login-NYYDDRZu.js
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: AUTH_PROVIDERS.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
							type: "button",
							variant: "line",
							className: "w-full",

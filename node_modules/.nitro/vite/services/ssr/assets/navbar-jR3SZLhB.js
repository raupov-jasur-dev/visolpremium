import { i as signOut } from "./client-sGid3STf.js";
import { n as cn, t as Button } from "./button-CvoGUxaL.js";
import { n as useCurrentUserState, t as useCurrentUser } from "./use-current-user-DZ7NZd4-.js";
	...
	return /* @__PURE__ */ jsxs("footer", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				})] }), COLS.map((col) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
					className: "text-xs tracking-[0.22em] text-gold uppercase",
					children: col.title
				}), /* @__PURE__ */ jsx("ul", {
					className: "mt-4 space-y-2 text-sm",
					children: col.links.map((l) => /* @__PURE__ */ jsx("li", { children: "params" in l ? /* @__PURE__ */ jsx(Link, {
						to: l.to,
						params: l.params,
...
//#endregion
//#region src/components/layout/auth-slot.tsx
function AuthSlot({ light = false }) {
	const { user, isPending } = useCurrentUserState();
	if (isPending) return /* @__PURE__ */ jsx("div", { className: "size-8 animate-pulse rounded-full bg-burgundy/15" });
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsx(AuthSlot, { light })
						}),
						/* @__PURE__ */ jsx(Button, {
							asChild: true,
							size: "sm",
							...
							children: /* @__PURE__ */ jsxs(Link, {
								to: "/templates",
								children: ["Yaratish", /* @__PURE__ */ jsx("span", {
									"aria-hidden": true,
									children: "→"
								})]
							})
...
//#endregion
export { RedirectToSignIn as n, Footer as r, Navbar as t };

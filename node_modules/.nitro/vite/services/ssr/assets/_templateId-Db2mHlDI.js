...
import { r as saveInvitation } from "./invitations-C11vnLDu.js";
import { o as Route } from "./router-Db6FSb6f.js";
import { n as cn, t as Button } from "./button-CvoGUxaL.js";
import { n as useCurrentUserState } from "./use-current-user-DZ7NZd4-.js";
import { a as stopMusic, c as asStringList, i as playMusic, l as compressImage, o as asBool, r as MUSIC_TRACKS, s as asString, t as InvitationRenderer, u as readAudio } from "./renderer-CTmHW4pb.js";
import { n as Label, r as Textarea, t as Input } from "./input-DIpVotSN.js";
import { t as useDraft } from "./draft-Cf-HfiEI.js";
import { useEffect, useMemo, useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { Check, Eye, Music2, Pencil, Upload, X } from "lucide-react";
import { toast } from "sonner";
//#region src/components/editor/field-input.tsx
function FieldInput({ field, value, onChange }) {
	...
	function render() {
		switch (field.type) {
			...
			case "boolean": return /* @__PURE__ */ jsxs("button", {
				type: "button",
				role: "switch",
				...
				children: [/* @__PURE__ */ jsx("span", { children: asBool(value) ? "Yoqilgan" : "O'chiq" }), /* @__PURE__ */ jsx("span", {
					className: cn("h-5 w-9 rounded-full p-0.5", asBool(value) ? "bg-gold" : "bg-muted/40"),
					children: /* @__PURE__ */ jsx("span", { className: cn("block size-4 rounded-full bg-ivory transition-transform duration-200", asBool(value) ? "translate-x-4" : "translate-x-0") })
				})]
			});
			case "select": return /* @__PURE__ */ jsx("select", {
				...
				value: asString(value),
				onChange: (e) => onChange(e.target.value),
				children: (field.options ?? []).map((o) => /* @__PURE__ */ jsx("option", {
					value: o.value,
					children: o.label
				}, o.value))
			});
			case "music": return /* @__PURE__ */ jsxs("div", {
				className: "space-y-2",
				children: [
					/* @__PURE__ */ jsx("div", {
						className: "grid grid-cols-2 gap-2",
						children: MUSIC_TRACKS.map((t) => /* @__PURE__ */ jsxs("button", {
							type: "button",
							...
							children: [/* @__PURE__ */ jsx(Music2, { className: "size-4" }), t.title]
						}, t.id))
					}),
					/* @__PURE__ */ jsxs("label", {
			...
			case "image": return /* @__PURE__ */ jsxs("label", {
				className: "flex min-h-28 cursor-pointer flex-col items-center justify-center gap-2 rounded-xl bg-cream text-sm",
				children: [asString(value) ? /* @__PURE__ */ jsx("img", {
					src: asString(value),
					alt: "",
					className: "max-h-40 rounded-lg object-cover"
				}) : /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Upload, { className: "size-5" }), "Rasm yuklash"] }), /* @__PURE__ */ jsx("input", {
					type: "file",
					accept: "image/*",
					className: "sr-only",
					onChange: async (e) => {
			...
			case "images": {
				...
				return /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [list.map((src, i) => /* @__PURE__ */ jsx("button", {
							type: "button",
						...
						}, src + i)), list.length < max && /* @__PURE__ */ jsxs("label", {
							className: "grid aspect-square cursor-pointer place-items-center rounded-lg bg-cream",
							children: [/* @__PURE__ */ jsx(Upload, { className: "size-5" }), /* @__PURE__ */ jsx("input", {
								type: "file",
								accept: "image/*",
								className: "sr-only",
								onChange: async (e) => {
			...
			case "video": return /* @__PURE__ */ jsx("p", {
...
//#endregion
//#region src/components/editor/edit-modal.tsx
...
function EditModal({ open, onOpenChange, template }) {
	...
	return /* @__PURE__ */ jsxs("aside", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: template.fields.map((field) => /* @__PURE__ */ jsx(FieldInput, {
				field,
...
//#endregion
//#region src/components/editor/editor-shell.tsx
function EditorShell({ templateId }) {
	...
	if (!template) return /* @__PURE__ */ jsx("main", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs(Button, {
							...
							children: [/* @__PURE__ */ jsx(Pencil, { className: "size-4" }), "Tahrirlash"]
						}),
						/* @__PURE__ */ jsxs(Button, {
							...
							children: [/* @__PURE__ */ jsx(Eye, { className: "size-4" }), "Ko'rish"]
						}),
						/* @__PURE__ */ jsxs(Button, {
							className: "flex-1",
							onClick: () => void onPublish(),
							disabled: saving,
							children: [/* @__PURE__ */ jsx(Check, { className: "size-4" }), saving ? "Saqlanmoqda…" : "Tayyorlash"]
						})
					]
				})
			}),
...
//#endregion
//#region src/routes/create/$templateId.tsx?tsr-split=component
function CreatePage() {
	const { templateId } = Route.useParams();
	return /* @__PURE__ */ jsx(EditorShell, { templateId });
}
//#endregion

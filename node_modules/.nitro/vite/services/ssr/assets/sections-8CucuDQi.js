import { n as PRICE, r as TEMPLATES, t as CATEGORIES } from "./templates-DNtH5Uvn.js";
import { n as cn, t as Button } from "./button-CvoGUxaL.js";
import { n as VideoSequence, t as InvitationRenderer } from "./renderer-CTmHW4pb.js";
import { t as formatPrice } from "./format-DYBbLPTX.js";
import { t as TemplateCard } from "./template-card-BNEqrWoe.js";
import { useEffect, useRef, useState } from "react";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { ImageIcon, Link2, MapPinned, Music2, QrCode, Smartphone, Sparkles, Timer, Users, Video, Wand2 } from "lucide-react";
//#region src/components/layout/reveal.tsx
	...
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs(Reveal, { children: [/* @__PURE__ */ jsx("p", {
				...
				children: CATEGORIES.map((c, i) => /* @__PURE__ */ jsx(Reveal, {
					delay: i * 70,
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs(Reveal, { children: [
				...
				children: /* @__PURE__ */ jsx("div", {
					...
					children: play ? /* @__PURE__ */ jsx(VideoSequence, {
						template: t,
						data: t.demo,
						playingDefault: true
	...
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs(Reveal, { children: [/* @__PURE__ */ jsx("p", {
				...
				children: TEMPLATES.map((t, i) => /* @__PURE__ */ jsx(Reveal, {
					delay: i % 3 * 70,
					children: /* @__PURE__ */ jsx(TemplateCard, { template: t })
				}, t.id))
			})]
		})
	});
	...
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsx("h2", {
				...
				children: QUOTES.map((q, i) => /* @__PURE__ */ jsxs("article", {
...
function FinalCta() {
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-burgundy-deep/55" }),
			/* @__PURE__ */ jsx("div", {
	...
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs(Reveal, { children: [/* @__PURE__ */ jsx("p", {
				...
				className: "mt-12 grid gap-6 md:grid-cols-2",
				children: TEMPLATES.slice(0, 4).map((t, i) => /* @__PURE__ */ jsx(Reveal, {
					delay: i * 80,
					children: /* @__PURE__ */ jsxs(Link, {
						to: "/create/$templateId",
						params: { templateId: t.id },
						...
						children: [
							...
							/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-ink/75 via-ink/10 to-transparent" }),
							/* @__PURE__ */ jsxs("div", {

...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-CUaBAgQw.js");
...
var manifest = {
	"0f4911293d06bd8e2dd524443e53108dd4eac59ec7f43082f04f260a18bfe7c9": {
		...
		importer: () => import("./assets/invitations-DN4RUQdG.js")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./assets/router-Db6FSb6f.js").then((n) => n.t),

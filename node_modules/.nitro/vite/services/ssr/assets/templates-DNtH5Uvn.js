...
var authMiddleware = createMiddleware({ type: "function" }).client(async ({ next }) => {
	const { getBearerToken } = await import("./client-sGid3STf.js").then((n) => n.n);
	return next({ sendContext: { bearerToken: getBearerToken() ?? void 0 } });
}).server(async ({ next, context }) => {
	const { assertSameSiteRequest } = await import("./isolation.server-CGNg1r0B.js");
	const { requireUserId } = await import("./verify.server-I2RZhPQj.js");
...
//#endregion
export { getTemplate as a, authMiddleware as c, getSql as d, getCategory as i, ensureDbReady as l, PRICE as n, invitationTitle as o, TEMPLATES as r, templatesByCategory as s, CATEGORIES as t, getPglite as u };

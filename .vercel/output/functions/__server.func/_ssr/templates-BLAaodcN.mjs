...
//#region node_modules/.nitro/vite/services/ssr/assets/templates-BLAaodcN.js
...
var authMiddleware = createMiddleware({ type: "function" }).client(async ({ next }) => {
	const { getBearerToken } = await import("./client-NDugtlEs.mjs").then((n) => n.n).then((n) => n.n);
	return next({ sendContext: { bearerToken: getBearerToken() ?? void 0 } });
}).server(async ({ next, context }) => {
	const { assertSameSiteRequest } = await import("./isolation.server-CGNg1r0B.mjs");
	const { requireUserId } = await import("./verify.server-R3gN_53n.mjs");
...
//#endregion
export { ensureDbReady as a, getTemplate as c, authMiddleware as i, invitationTitle as l, PRICE as n, getCategory as o, TEMPLATES as r, getSql as s, CATEGORIES as t, templatesByCategory as u };

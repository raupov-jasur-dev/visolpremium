...
import { _ as T$1, a as Re$2, b as u, c as Yr, d as wt$2, f as p$1, g as R$1, h as P$2, i as I$1, l as at$2, m as L$2, n as B$2, p as F$1, s as We$2, t as At$1, u as jr, v as U$2, x as x$1, y as h } from "./chunk-TDKVRJ2S-BQXvL49b.js";
...
var T = class {
	constructor(t = 256) {
		...
		R$1(this, O$1, 0);
		x$1(this, b, T$1(this, S$1, ie$1).call(this, t));
	}
	addInt32(t) {
		return T$1(this, S$1, L$1).call(this, 4), h(this, b).setInt32(h(this, g$1), t, h(this, k)), x$1(this, g$1, h(this, g$1) + 4), this;
	}
	addInt16(t) {
		return T$1(this, S$1, L$1).call(this, 2), h(this, b).setInt16(h(this, g$1), t, h(this, k)), x$1(this, g$1, h(this, g$1) + 2), this;
	}
	addCString(t) {
		return t && this.addString(t), T$1(this, S$1, L$1).call(this, 1), h(this, b).setUint8(h(this, g$1), 0), U$2(this, g$1)._++, this;
	}
	addString(t = "") {
		let n = P$1(t);
		return T$1(this, S$1, L$1).call(this, n), h(this, ae$1).encodeInto(t, new Uint8Array(h(this, b).buffer, h(this, g$1))), x$1(this, g$1, h(this, g$1) + n), this;
	}
	add(t) {
		return T$1(this, S$1, L$1).call(this, t.byteLength), new Uint8Array(h(this, b).buffer).set(new Uint8Array(t), h(this, g$1)), x$1(this, g$1, h(this, g$1) + t.byteLength), this;
	}
	flush(t) {
		let n = T$1(this, S$1, Je$1).call(this, t);
		return x$1(this, g$1, 5), x$1(this, b, T$1(this, S$1, ie$1).call(this, this.size)), new Uint8Array(n);
	}
};
b = /* @__PURE__ */ new WeakMap(), g$1 = /* @__PURE__ */ new WeakMap(), k = /* @__PURE__ */ new WeakMap(), ae$1 = /* @__PURE__ */ new WeakMap(), O$1 = /* @__PURE__ */ new WeakMap(), S$1 = /* @__PURE__ */ new WeakSet(), ie$1 = function(t) {
	...
	if (h(this, b).byteLength - h(this, g$1) < t) {
		...
		x$1(this, b, T$1(this, S$1, ie$1).call(this, i)), new Uint8Array(h(this, b).buffer).set(new Uint8Array(s));
	}
}, Je$1 = function(t) {
	if (t) {
...
var ue$1 = class {
	...
	setBuffer(t, n) {
		x$1(this, w, t), x$1(this, R, new DataView(n));
	}
	int16() {
		let t = h(this, R).getInt16(h(this, w), h(this, te));
		return x$1(this, w, h(this, w) + 2), t;
	}
	byte() {
	...
	int32() {
		...
		return x$1(this, w, h(this, w) + 4), t;
	}
	string(t) {
	...
	cstring() {
		...
		return x$1(this, w, n), s;
	}
	bytes(t) {
		let n = h(this, R).buffer.slice(h(this, w), h(this, w) + t);
		return x$1(this, w, h(this, w) + t), new Uint8Array(n);
	}
};
...
var pe$1 = class {
	...
	parse(t, n) {
		...
		let s = h(this, D) + h(this, B$1), i = h(this, D);
		for (; i + Xe$1 <= s;) {
			...
			if (m + i <= s && u > 0) {
				...
				try {
					...
					throw T$1(this, c, ke$1).call(this), E;
				}
				n(l), i += m;
			} else break;
		}
		i === s ? T$1(this, c, ke$1).call(this) : (x$1(this, B$1, s - i), x$1(this, D, i));
	}
};
A = /* @__PURE__ */ new WeakMap(), B$1 = /* @__PURE__ */ new WeakMap(), D = /* @__PURE__ */ new WeakMap(), o$1 = /* @__PURE__ */ new WeakMap(), c = /* @__PURE__ */ new WeakSet(), ke$1 = function() {
	x$1(this, A, new DataView(Ze$1)), x$1(this, B$1, 0), x$1(this, D, 0);
}, et$1 = function(t) {
	if (h(this, B$1) > 0) {
		let n = h(this, B$1) + t.byteLength;
		if (n + h(this, D) > h(this, A).byteLength) {
			let i;
			if (n <= h(this, A).byteLength && h(this, D) >= h(this, B$1)) i = h(this, A).buffer;
			else {
				let a = h(this, A).byteLength * 2;
				for (; n >= a;) a *= 2;
				i = new ArrayBuffer(a);
			}
			new Uint8Array(i).set(new Uint8Array(h(this, A).buffer, h(this, D), h(this, B$1))), x$1(this, A, new DataView(i)), x$1(this, D, 0);
		}
		new Uint8Array(h(this, A).buffer).set(new Uint8Array(t), h(this, D) + h(this, B$1)), x$1(this, B$1, n);
	} else x$1(this, A, new DataView(t)), x$1(this, D, 0), x$1(this, B$1, t.byteLength);
...
var z$1 = class {
	...
	async query(s, e, r) {
		return await this._checkReady(), await this._runExclusiveTransaction(async () => await T$1(this, t, x).call(this, s, e, r));
	}
	async sql(s, ...e) {
	...
	async transaction(s) {
		return await this._checkReady(), await this._runExclusiveTransaction(async () => {
			await T$1(this, t, m).call(this, "BEGIN"), x$1(this, p, !0);
			let e = !1, r = () => {
				if (e) throw new Error("Transaction is closed");
			}, o = {
				query: async (i, c, u) => (r(), await T$1(this, t, x).call(this, i, c, u)),
				sql: async (i, ...c) => {
					r();
					let { query: u, params: n } = g(i, ...c);
					return await T$1(this, t, x).call(this, u, n);
				},
			...
			try {
				let i = await s(o);
				return e || (e = !0, await T$1(this, t, m).call(this, "COMMIT")), x$1(this, p, !1), i;
			} catch (i) {
				throw e || (e = !0, await T$1(this, t, m).call(this, "ROLLBACK")), x$1(this, p, !1), i;
			}
		});
	}
...
async function je(e, t) {
	let r;
	if (e && t === "nodefs") {
		let { NodeFS: a } = await import("./nodefs-LB3BdhAs.js");
		r = new a(e);
	} else if (e && t === "idbfs") r = new ve(e);
	else if (e && t === "opfs-ahp") {
		let { OpfsAhpFS: a } = await import("./opfs-ahp-BiTMd50f.js");
		r = new a(e);
	} else r = new Ee();
	return r;
}
...
var O = class O extends z$1 {
	constructor(r = {}, a = {}) {
		...
		typeof r == "string" ? a = {
			...
			...this.serializers,
			...a.serializers
		}), a?.debug !== void 0 && (this.debug = a.debug), a?.relaxedDurability !== void 0 && x$1(this, ie, a.relaxedDurability), x$1(this, ue, a.extensions ?? {}), this.waitReady = T$1(this, S, Ye).call(this, a ?? {});
	}
	get ENV() {
		return this.mod?.ENV;
	}
	...
	async close() {
		await this._checkReady(), x$1(this, _e, !0);
		for (let a of h(this, Me)) await a();
		try {
			this.mod._pgl_setPGliteActive(0), await this.execProtocol($e$1.end()), this.mod._pgl_run_atexit_funcs();
		} catch (a) {
			let o = a;
			o.name === "ExitStatus" && o.status === 0 || T$1(this, S, U).call(this, "An error occured while closing the db", a.toString());
		} finally {
			this.mod.removeFunction(h(this, me)), this.mod.removeFunction(h(this, ce));
		}
		await this.fs.closeFs(), x$1(this, se, !0), x$1(this, _e, !1), x$1(this, oe, !1), x$1(this, ge, !1);
		let r = p$1.pgliteProc.exitCode;
		try {
			this.mod._emscripten_force_exit(0);
		} catch (a) {
			T$1(this, S, U).call(this, a), a.status !== 0 && T$1(this, S, U).call(this, "Error when exiting", a.toString());
		} finally {
	...
	async _handleBlob(r) {
		x$1(this, ne, r ? await r.arrayBuffer() : void 0);
	}
	async _cleanupBlob() {
		x$1(this, ne, void 0);
	}
	...
	execProtocolRawSync(r) {
		let a = this.mod;
		if (x$1(this, V, 0), x$1(this, B, 0), x$1(this, $, r), h(this, W) || x$1(this, W, T$1(this, S, et)), h(this, L).length !== O.DEFAULT_RECV_BUF_SIZE && x$1(this, L, new Uint8Array(O.DEFAULT_RECV_BUF_SIZE)), r[0] === 88) return /* @__PURE__ */ new Uint8Array(0);
		if (r[0] === 0) return T$1(this, S, st).call(this, r);
		let o = p$1.pgliteProc.exitCode;
		try {
			for (; h(this, V) < r.length || a._pq_buffer_remaining_data() > 0;) try {
				a._PostgresMainLoopOnce();
			} catch (_) {
				_.status === this.POSTGRES_MAIN_LONGJMP && a._PostgresMainLongJmp();
			}
		} finally {
			a._PostgresSendReadyForQueryIfNecessary(), a._pgl_pq_flush(), p$1.pgliteProc.exitCode = o;
		}
		return x$1(this, $, []), h(this, B) ? new Uint8Array(h(this, L).subarray(0, h(this, B))) : /* @__PURE__ */ new Uint8Array(0);
	}
	...
	async execProtocolRawStream(r, { syncToFs: a = !0, onRawData: o }) {
		x$1(this, W, (_) => (o(_), _.length)), this.execProtocolRawSync(r), a && await this.syncToFs();
	}
	async execProtocol(r, { syncToFs: a = !0, throwOnError: o = !0, onNotice: _ } = {}) {
		...
		if (x$1(this, I, new ae()), x$1(this, W, void 0), o && n) throw x$1(this, pe, new pe$1()), n;
		return l;
	}
	async execProtocolStream(r, { syncToFs: a, throwOnError: o = !0, onNotice: _ } = {}) {
		x$1(this, I, new ae({
			throwOnError: o,
			onNotice: _
		})), x$1(this, W, T$1(this, S, qe)), await this.execProtocolRaw(r, { syncToFs: a });
		let s = h(this, I).databaseError, n = h(this, I).results;
		if (x$1(this, I, new ae()), x$1(this, W, void 0), o && s) throw x$1(this, pe, new pe$1()), s;
		return n;
	}
	isInTransaction() {
	...
	async syncToFs() {
		...
		let r = async () => {
			await h(this, Ce).runExclusive(async () => {
				x$1(this, de, !1), await this.fs.syncToFs(h(this, ie));
			});
		};
		h(this, ie) ? r() : await r();
	}
	async listen(r, a, o) {
		return this._runExclusiveListen(() => T$1(this, S, rt).call(this, r, a, o));
	}
	async unlisten(r, a, o) {
		return this._runExclusiveListen(() => T$1(this, S, at).call(this, r, a, o));
	}
	onNotification(r) {
	...
	_runExclusiveQuery(r) {
		return h(this, ke).runExclusive(r);
	}
...
W = /* @__PURE__ */ new WeakMap(), oe = /* @__PURE__ */ new WeakMap(), _e = /* @__PURE__ */ new WeakMap(), se = /* @__PURE__ */ new WeakMap(), ie = /* @__PURE__ */ new WeakMap(), ke = /* @__PURE__ */ new WeakMap(), Te$1 = /* @__PURE__ */ new WeakMap(), Pe = /* @__PURE__ */ new WeakMap(), Ce = /* @__PURE__ */ new WeakMap(), de = /* @__PURE__ */ new WeakMap(), ue = /* @__PURE__ */ new WeakMap(), Me = /* @__PURE__ */ new WeakMap(), pe = /* @__PURE__ */ new WeakMap(), ne = /* @__PURE__ */ new WeakMap(), ee = /* @__PURE__ */ new WeakMap(), z = /* @__PURE__ */ new WeakMap(), le = /* @__PURE__ */ new WeakMap(), ce = /* @__PURE__ */ new WeakMap(), I = /* @__PURE__ */ new WeakMap(), me = /* @__PURE__ */ new WeakMap(), $ = /* @__PURE__ */ new WeakMap(), V = /* @__PURE__ */ new WeakMap(), L = /* @__PURE__ */ new WeakMap(), B = /* @__PURE__ */ new WeakMap(), he = /* @__PURE__ */ new WeakMap(), xe = /* @__PURE__ */ new WeakMap(), we = /* @__PURE__ */ new WeakMap(), ge = /* @__PURE__ */ new WeakMap(), S = /* @__PURE__ */ new WeakSet(), Xe = function(r) {
	this.debug && console.debug(r);
}, Ke = function(r) {
	this.debug && console.error(r);
}, Ye = async function(r) {
	let a = p$1.pgliteProc.exitCode;
	...
	let n = new URL("../../@electric-sql/pglite/dist/pglite.data", import.meta.url), l = r.fsBundle ? r.fsBundle.arrayBuffer() : p$1.getFsBundle(n), d;
	l.then((m) => {
		d = m;
	});
	let u = new WebAssembly.Memory({
		...
		stdin: () => null,
		print: (m) => {
			T$1(this, S, Xe).call(this, m);
		},
		printErr: (m) => {
			T$1(this, S, Ke).call(this, m);
		},
		instantiateWasm: (m, p) => {
			let h = new URL("../../@electric-sql/pglite/dist/pglite.wasm", import.meta.url);
			return p$1.instantiateWasm(m, h, r.pgliteWasmModule).then(({ instance: x, module: b }) => {
				p(x, b);
			}), {};
		},
		...
		preRun: [
			...
			(m) => {
				...
				m.FS.registerDevice(p, {
					...
					write: (x, b, M, y, E) => (h(this, ee) ?? x$1(this, ee, []), h(this, ee).push(b.slice(M, M + y)), y),
					llseek: (x, b, M) => {
						let y = h(this, ne);
	...
	c = f;
	let g = [];
	for (let [m, p] of Object.entries(h(this, ue))) if (p instanceof URL) o[m] = Re(p);
	else {
		let h$1 = await p.setup(this, c);
		if (h$1.emscriptenOpts && (c = h$1.emscriptenOpts), h$1.namespaceObj) {
			let x = this;
			x[m] = h$1.namespaceObj;
		}
		h$1.bundlePath && (o[m] = Re(h$1.bundlePath)), h$1.init && _.push(h$1.init), h$1.close && h(this, Me).push(h$1.close), g.push(...h$1.sharedPreloadLibraries ?? []);
	}
	if (c.pg_extensions = o, await l, this.mod = await We(c), await this.fs.initialSyncFs(), r.icuDataDir && await T$1(this, S, $e).call(this, r.icuDataDir), !r.noInitDb) {
		if (r.loadDataDir) {
			...
			T$1(this, S, U).call(this, "pglite: loading data from tarball"), await at$2(this.mod.FS, r.loadDataDir, B$2);
		} else if (this.mod.FS.analyzePath("/pglite/data/PG_VERSION").exists) T$1(this, S, U).call(this, "pglite: found DB, resuming");
		else {
			T$1(this, S, U).call(this, "pglite: no db in filesystem, running initdb");
			let m = { ...r };
		...
		await Ue(this.mod, (...m) => T$1(this, S, U).call(this, ...m)), T$1(this, S, Qe).call(this, g, r), this.mod._pgl_setPGliteActive(1), T$1(this, S, _t).call(this, {
			pgDataFolder: B$2,
			startParams: [...r.startParams || O.defaultStartParams, ...this.debug ? ["-d", this.debug.toString()] : []]
		}), T$1(this, S, ot).call(this), x$1(this, oe, !0), r.username && await this.exec(`SET ROLE ${r.username};`), await this._initArrayTypes();
		for (let m of _) await m();
	}
	p$1.pgliteProc.exitCode = a;
}, Qe = function(r, a) {
...
shared_preload_libraries=${r.join(",")}`;
	...
	T$1(this, S, U).call(this, `pglite: icuDataDir specified, removing default icu data dir at ${jr}`), p$1.rmdirRecursive(this.mod.FS, jr), T$1(this, S, U).call(this, `pglite: loading icu data from tarball ${r}`), this.mod.FS.mkdirTree(jr), await at$2(this.mod.FS, r, jr);
}, Je = function(r) {
	x$1(this, he, r.addFunction((a) => (T$1(this, S, U).call(this, `Postgres tried to execute ${r.UTF8ToString(a)}, returning 1.`), 1), "pi")), r._pgl_set_system_fn(h(this, he)), x$1(this, xe, r.addFunction((a, o) => {
	...
	}, "ppp")), r._pgl_set_popen_fn(h(this, xe)), x$1(this, we, r.addFunction((a) => {
		...
		T$1(this, S, U).call(this, "pclose_fn", a);
	}, "pi")), r._pgl_set_pclose_fn(h(this, we)), x$1(this, ce, r.addFunction((a, o) => {
		let _;
		try {
		...
		return h(this, W).call(this, _);
	}, "iii")), x$1(this, me, r.addFunction((a, o) => {
		let _ = h(this, $).length - h(this, V);
		return _ > o && (_ = o), this.mod.HEAP8.set(h(this, $).subarray(h(this, V), h(this, V) + _), a), x$1(this, V, h(this, V) + _), _;
	}, "iii")), r._pgl_set_rw_cbs(h(this, me), h(this, ce));
}, et = function(r) {
	let a = r.slice(), o = h(this, B) + a.length;
	if (o > h(this, L).length) {
		let _ = h(this, L).length + (h(this, L).length >> 1) + o;
		o > O.MAX_BUFFER_SIZE && (o = O.MAX_BUFFER_SIZE);
		let s = new Uint8Array(_);
		s.set(h(this, L).subarray(0, h(this, B))), x$1(this, L, s);
	}
	return h(this, L).set(a, h(this, B)), x$1(this, B, h(this, B) + a.length), T$1(this, S, qe).call(this, a);
}, qe = function(r) {
	return h(this, pe).parse(r, (a) => {
		let o = T$1(this, S, tt).call(this, a);
		o && h(this, I).results.push(o);
	}), r.length;
}, tt = function(r) {
	if (!h(this, I).databaseError) {
		if (r instanceof N) h(this, I).throwOnError && (h(this, I).databaseError = r);
		else if (r instanceof ee$1) this.debug > 0 && console.warn(r), h(this, I).onNotice && h(this, I).onNotice(r);
		else if (r instanceof J$1) {
			let a = h(this, z).get(r.channel);
			a && a.forEach((o) => {
	...
	h(this, z).has(_) || h(this, z).set(_, /* @__PURE__ */ new Set()), h(this, z).get(_).add(a);
	try {
		await s.exec(`LISTEN ${r}`);
	} catch (n) {
		throw h(this, z).get(_).delete(a), h(this, z).get(_)?.size === 0 && h(this, z).delete(_), n;
	}
	return async (n) => {
	...
	let _ = p$1.toPostgresName(r), s = o ?? this, n = async () => {
		await s.exec(`UNLISTEN ${r}`), h(this, z).get(_)?.size === 0 && h(this, z).delete(_);
	};
	a ? (h(this, z).get(_)?.delete(a), h(this, z).get(_)?.size === 0 && await n()) : await n();
}, ot = function() {
	if (h(this, ge)) throw new Error("PGlite single mode already running");
	this.mod._pgl_startPGlite(), x$1(this, ge, !0);
}, _t = function(r) {
	let a = [
		...r.startParams,
		"-D",
	...
	x$1(this, V, 0), x$1(this, B, 0), x$1(this, $, r);
	...
	return this.mod._pgl_sendConnData(), this.mod._pgl_pq_flush(), x$1(this, $, []), h(this, B) ? h(this, L).subarray(0, h(this, B)) : /* @__PURE__ */ new Uint8Array(0);
}, O.paths = {
	PG_ROOT: I$1,
	PGDATA: B$2,
	ICU_DATA_PATH: jr,

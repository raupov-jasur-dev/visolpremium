  ...
  return (
    <section className="bg-cream py-24">
      <div className="mx-auto grid max-w-6xl items-center gap-12 px-6 lg:grid-cols-2">
        ...
        <Reveal delay={100}>
          <div className="mx-auto max-h-[640px] w-[min(360px,100%)] overflow-auto rounded-[24px] shadow-[0_30px_80px_-28px_rgba(44,31,26,0.45)]">
            <InvitationRenderer template={t} data={t.demo} />
          </div>
        </Reveal>
      </div>
    </section>

...
import { n as formatUzDate, r as formatUzDateLong } from "./format-DYBbLPTX.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/renderer-CTmHW4pb.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: template.sections.map((section) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Section, {
					id: section,
					template,
					data,
					compact,
...
function Section({ id, template, data, compact, dark }) {
	...
	switch (id) {
		case "cover": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-gradient-to-t from-ink/70 via-ink/20 to-ink/10" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(GoldFrame, { className: "absolute inset-4 text-gold/80" }),
				template.theme.style === "floral" || template.theme.style === "garden" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FloralCorner, { className: "absolute top-6 left-6 w-16 text-gold/70" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FloralCorner, { className: "absolute right-6 bottom-6 w-16 rotate-180 text-gold/70" })] }) : null,
				template.theme.style === "ornament" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StarMedallion, { className: "absolute top-8 left-1/2 w-16 -translate-x-1/2 text-gold" }) : null,
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		case "names": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			className: cn(pad, "text-center"),
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "gold-line mx-auto mb-5" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
		...
		case "verse": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			className: cn(pad, "text-center"),
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
		...
		case "datetime": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			className: cn(pad, "text-center"),
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-[11px] tracking-[0.28em] uppercase opacity-70",
				...
				asString(data.time) ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-1 text-lg opacity-80",
					children: asString(data.time)
				}) : null
			]
		});
		case "event": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			className: cn(pad, "text-center"),
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-[11px] tracking-[0.28em] uppercase opacity-70",
				...
				asString(data.address) ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapPin, { className: "size-4" }), asString(data.address) || "Manzil"]
					}),
		...
		case "message": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			className: cn(pad, "text-center"),
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
		...
		case "host": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			className: cn(pad, "text-center"),
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "text-[11px] tracking-[0.22em] uppercase opacity-70",
				children: "Mezbon"
		...
		case "age": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			className: cn(pad, "text-center"),
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
		...
		case "video-sequence": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(VideoSequence, {
			template,
			data,
			compact
		});
		case "footer": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("footer", {
			className: cn(pad, "text-center"),
			children: [
				...
				asString(data.greeting) ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {

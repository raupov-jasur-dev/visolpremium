...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B586FRrj.mjs");
...
var manifest = {
	"0f4911293d06bd8e2dd524443e53108dd4eac59ec7f43082f04f260a18bfe7c9": {
		...
		importer: () => import("./invitations-EpB22vRy.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CVdbLN9V.mjs").then((n) => n.t),

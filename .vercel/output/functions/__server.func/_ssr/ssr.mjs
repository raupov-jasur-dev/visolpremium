...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-JmBE527F.mjs");
...
var manifest = {
	"0f4911293d06bd8e2dd524443e53108dd4eac59ec7f43082f04f260a18bfe7c9": {
		...
		importer: () => import("./invitations-DG6zH-Oy.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BgGKuGxY.mjs").then((n) => n.t),
